...
from .views import get_library_data_view, get_shelf_list_view, get_shelves_with_current_book_view, add_shelf_view, edit_shelf_view, remove_shelf_view, add_book_to_shelf_view, remove_book_from_shelf_view, add_book_to_wishlist_view, remove_book_from_wishlist_view, add_book_to_history_view, remove_book_from_history_view
